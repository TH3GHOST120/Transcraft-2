...
public class ResearchItem {
	...
	/**
	 * Research that can be directly purchased with RP in normal research
	 * difficulty.
	 */
	...
	/**
	 * Hidden research can only be discovered via scanning or knowledge
	 * fragments
	 */
	...
	/**
	 * Scanning these items will have a chance of revealing hidden knowledge in
	 * the thaumonomicon
	 */
	private ItemStack[]				itemTriggers;

	/**
	 * Scanning these entities will have a chance of revealing hidden knowledge
	 * in the thaumonomicon
	 */
	private String[]				entityTriggers;

	/**
	 * Scanning things with these aspects will have a chance of revealing hidden
	 * knowledge in the thaumonomicon
	 */
