...
public class DimTp extends Teleporter {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double x, double y, double z, float par8) {
			...
			for (var48 = var15 - var9; var48 <= var15 + var9; ++var48) {
				...
				for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23) {
					...
					for (int var26 = worldServerInstance.getActualHeight() - 1; var26 >= 0; --var26) {
						if (worldServerInstance.getBlock(var48, var26, var23) == Blocks.grass) {
							while (worldServerInstance.getBlock(var48, var26 - 1, var23) == Blocks.grass) {
								--var26;
							}
		...
		if (var10 >= 0.0D) {
			...
			if (worldServerInstance.getBlock(i - 1, j, k) == TranscraftBlocks.DriedTransmutter) {
				var50 = 2;
			}
			...
			if (worldServerInstance.getBlock(i, j, k - 1) == TranscraftBlocks.DriedTransmutter) {
				var50 = 3;
			}
			...
			if (var50 > -1) {
				...
				if (var50 == var30) {
					...
					if (var50 == Direction.rotateOpposite[var30]) {
						var40 = -1.0F;
						var41 = -1.0F;
					}
					else
						if (var50 == Direction.rotateRight[var30]) {
							var42 = 1.0F;
							var43 = -1.0F;
						}
						else {
