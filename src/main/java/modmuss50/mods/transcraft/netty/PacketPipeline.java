package modmuss50.mods.transcraft.netty;
...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
	...
	public void initalise() {
		this.channels = NetworkRegistry.INSTANCE.newChannel("Transcraft", this);
		registerPackets();
	}

	private void registerPackets() {
		registerPacket(PacketQuartz.class);
		registerPacket(PacketEnderDigger.class);
	}
