...
public class TranscraftItems {
	...
	public static Item	Technium;
	public static Item	BunkerPick;
	public static Item	EnderSword;
	public static Item	MagicalTransmutter;
	...
	public static Item	TechniumBoots;
	public static Item	TechniumChestplate;
	public static Item	TechniumHelmet;
	public static Item	TechniumLeggs;

	public static Item	ColorCopier;
}
