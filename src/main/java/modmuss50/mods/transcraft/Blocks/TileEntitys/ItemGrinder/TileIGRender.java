...
public class TileIGRender extends TileEntitySpecialRenderer {
	 ...
	 */
	public void renderTileECAt(ItemGrinderTile par1TileEC, double par2, double par4, double par6, float par8) {
		int i;
		...
		GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
		float f1 = par1TileEC.prevLidAngle + (par1TileEC.lidAngle - par1TileEC.prevLidAngle) * par8;
		f1 = 1.0F - f1;
		f1 = 1.0F - f1 * f1 * f1;
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		this.renderTileECAt((ItemGrinderTile) par1TileEntity, par2, par4, par6, par8);
	}
