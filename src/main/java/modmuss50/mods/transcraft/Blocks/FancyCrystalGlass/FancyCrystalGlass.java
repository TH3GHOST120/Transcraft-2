...
public class FancyCrystalGlass extends BetterColoredBlock {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		icons[0] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass");
		icons[1] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_1_d");
		icons[2] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_1_u");
		icons[3] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_1_l");
		icons[4] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_1_r");
		icons[5] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_2_h");
		icons[6] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_2_v");
		icons[7] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_2_dl");
		icons[8] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_2_dr");
		icons[9] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_2_ul");
		icons[10] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_2_ur");
		icons[11] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_3_d");
		icons[12] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_3_u");
		icons[13] = par1IconRegister.registerIcon("Transcraft:glass/FancyGlass/glass_3_l");
