...
public class FxEnderDigger extends EntityFX {
	...
	public static final ResourceLocation	texture			= new ResourceLocation("transcraft", "textures/particles/enderDigger.png");

	public FxEnderDigger(World par1World, double x, double y, double z, double tx, double ty, double tz, float red, float green, float blue, int age) {
